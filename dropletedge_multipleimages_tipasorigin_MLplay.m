...
clear all;
pkg load image;
strp = './Motion for Suman/water, 250 ms, 148 V, 1920 x1080, 1500 fps/'; % % where the images are placed
strpy = './Motion for Suman/analyzed files/location_tipsorigin/'; %ylocation
